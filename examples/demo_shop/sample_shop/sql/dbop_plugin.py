...
from smartswitch import BasePlugin, MethodEntry
...
class DbopPlugin(BasePlugin):
    ...
    def wrap_handler(
        ...
        Args:
            switch: Switcher instance
            entry: MethodEntry with handler metadata
            call_next: Next handler in the plugin chain
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                # Call next handler in chain with injected cursor
