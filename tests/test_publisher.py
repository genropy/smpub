"""
Tests for Publisher and PublishedClass.
"""
...
from smpub import Publisher, PublishedClass, PublisherContext


# Test fixtures
class SimpleHandler(PublishedClass):
...
class TypedHandler(PublishedClass):
...
class TestPublishedClass:
    """Test PublishedClass mixin."""

    def test_has_publisher_slot(self):
